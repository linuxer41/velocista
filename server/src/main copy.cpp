...
// const float RPM_TO_PWM = 255.0f / 300.0f;
...
//                 float leftRPM = baseRPM - steerRPM;
//                 float rightRPM = baseRPM + steerRPM;
//                 left.pwm = constrain(leftRPM * RPM_TO_PWM, -255, 255);
//                 right.pwm = constrain(rightRPM * RPM_TO_PWM, -255, 255);
//                 break;
//             }
