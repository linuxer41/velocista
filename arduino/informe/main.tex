...
Fragmento del código de control PID (de \texttt{src/main.cpp}):
...
Ver archivo \texttt{analisis\_datos.m} en anexos para el procesamiento de datos y gráficas.
...
\begin{enumerate}[leftmargin=1.2em]
  \item \texttt{server.zip} – Proyecto completo:
    \begin{itemize}
      \item \texttt{src/main.cpp} – Control en cascada PID con anti-windup
  ...
  \item Carpeta \texttt{matlab/} – Scripts MATLAB utilizados:
    \begin{itemize}
      \item \texttt{analisis\_datos.m} – análisis de datos reales y gráficas de desempeño
      ...
      \item \texttt{rlocus\_continuo.m} – ajuste de K mediante lugar de raíces continuo
      \item \texttt{validacion.m} – validación del modelo
    \end{itemize}

  \subsection{Códigos MATLAB}
  ...
  \lstinputlisting[language=Matlab]{matlab/rlocus_continuo.m}
