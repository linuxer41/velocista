...
class AppState extends ChangeNotifier {
  ...
  final ValueNotifier<ConfigData?> configData = ValueNotifier(null);
    ...
    if (line.startsWith('type:1|')) {
      ...
      try {
        ...
        if (parsedConfigData != null) {
          ...
          if (parsedConfigData.mode != null) {
            currentMode.value = OperationMode.fromId(parsedConfigData.mode!);
          }
    ...
    try {
      ...
      if (serialData != null) {
        ...
        if (serialData is TelemetryData) {
          ...
          final leftRpm = serialData.left != null && serialData.left!.isNotEmpty
              ? serialData.left![0]
              : 0.0;
          final rightRpm =
              serialData.right != null && serialData.right!.isNotEmpty
                  ? serialData.right![0]
                  : 0.0;
          final leftEncoderCount =
              serialData.left != null && serialData.left!.length > 3
                  ? serialData.left![3].toInt()
                  : 0;
          final rightEncoderCount =
              serialData.right != null && serialData.right!.length > 3
                  ? serialData.right![3].toInt()
                  : 0;
          ...
          // Update configData ValueNotifier
          configData.value = serialData;
        }
